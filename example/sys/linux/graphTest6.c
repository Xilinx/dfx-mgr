...
int testGraph(void){
    ...
    LINK_HANDLE lHandle_01      = Graph_connectInputBuffer (gHandle, aHandle_01,      bHandle_00, 0x00, TRANSACTION_SIZE, 0, 0);
    LINK_HANDLE lHandle_02      = Graph_connectOutputBuffer(gHandle, aHandle_01,      bHandle_01, 0x00, TRANSACTION_SIZE, 0, 0);
    LINK_HANDLE lHandle_03      = Graph_connectInputBuffer (gHandle, outputHandle_02, bHandle_01, 0x00, TRANSACTION_SIZE, 0, 0);
