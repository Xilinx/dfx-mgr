...
int main(void){
	...
	AbstractAccelNode_t *accelNode2 = addAcceleratorNode(acapGraph, "AES128");
	//AbstractAccelNode_t *accelNode3 = addAcceleratorNode(acapGraph, "AES128");
	...
	//addInBuffer (acapGraph, accelNode3, buffNode2, 0x00, 32*1024*1024, 4, 0);
	//addOutBuffer(acapGraph, accelNode3, buffNode3, 0x00, 32*1024*1024, 4, 0);

	addInBuffer (acapGraph, accelNode4, buffNode2, 0x00, 32*1024*1024, 6, 0);
