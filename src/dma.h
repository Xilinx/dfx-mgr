...
static inline void acapd_dma_init_config(acapd_dma_config_t *config, acapd_shm_t *shm, void *va,
...
int acapd_dma_poll(acapd_chnl_t *chnl, uint32_t wait_for_complete, acapd_dma_cb_t poll_cb,
				   uint32_t timeout);
